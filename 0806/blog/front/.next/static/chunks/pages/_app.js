...
_c = App;
/* harmony default export */ __webpack_exports__["default"] = (_c2 = _store_configureStore__WEBPACK_IMPORTED_MODULE_2__.default.withRedux(App));
...
/* harmony import */ var _saga_index__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../saga/index */ "./saga/index.js");
/* module decorator */ module = __webpack_require__.hmd(module);
...
var configureStore = function configureStore() {
  ...
  var middlewares = [sagaMiddleware]; //개발모드와 배포모드를 다르게 하겠다는 것

  var enhancer =  false ? 0 : (0,redux_devtools_extension__WEBPACK_IMPORTED_MODULE_2__.composeWithDevTools)(redux__WEBPACK_IMPORTED_MODULE_6__.applyMiddleware.apply(void 0, middlewares));
  var Store = (0,redux__WEBPACK_IMPORTED_MODULE_6__.createStore)(_reducers__WEBPACK_IMPORTED_MODULE_1__.default, enhancer);
  Store.sagaTask = sagaMiddleware.run(_saga_index__WEBPACK_IMPORTED_MODULE_5__.default); //===createContext(reducer) 
  //-===createContext(상태초기값)
